...
SERVO_LEG_FWARD_PAIR1_MD0 = [SERVO_LEG_MID+SERVO_LEG_STEP -  47, SERVO_LEG_MID+SERVO_LEG_STEP +  30, SERVO_LEG_MID-SERVO_LEG_STEP -  32]
SERVO_LEG_FWARD_PAIR2_MD0 = [SERVO_LEG_MID+SERVO_LEG_STEP - 150, SERVO_LEG_MID-SERVO_LEG_STEP -   2, SERVO_LEG_MID-SERVO_LEG_STEP + 187]
SERVO_LEG_BACK_PAIR1_MD0  = [SERVO_LEG_MID-SERVO_LEG_STEP -  50, SERVO_LEG_MID-SERVO_LEG_STEP -  23, SERVO_LEG_MID+SERVO_LEG_STEP - 100]
SERVO_LEG_BACK_PAIR2_MD0  = [SERVO_LEG_MID-SERVO_LEG_STEP -  30, SERVO_LEG_MID+SERVO_LEG_STEP -  30, SERVO_LEG_MID+SERVO_LEG_STEP + 57]

SERVO_LEG_FWARD_PAIR1_MD1 = [SERVO_LEG_MID+SERVO_LEG_STEP -  23, SERVO_LEG_MID+SERVO_LEG_STEP +  15, SERVO_LEG_MID-SERVO_LEG_STEP -  16]
SERVO_LEG_FWARD_PAIR2_MD1 = [SERVO_LEG_MID+SERVO_LEG_STEP -  75, SERVO_LEG_MID-SERVO_LEG_STEP -   1, SERVO_LEG_MID-SERVO_LEG_STEP +  93]
SERVO_LEG_BACK_PAIR1_MD1  = [SERVO_LEG_MID-SERVO_LEG_STEP -  25, SERVO_LEG_MID-SERVO_LEG_STEP -  12, SERVO_LEG_MID+SERVO_LEG_STEP -  50]
SERVO_LEG_BACK_PAIR2_MD1  = [SERVO_LEG_MID-SERVO_LEG_STEP -  15, SERVO_LEG_MID+SERVO_LEG_STEP -  15, SERVO_LEG_MID+SERVO_LEG_STEP +  28]

SERVO_LEG_FWARD_PAIR1_MD2 = [SERVO_LEG_MID+SERVO_LEG_STEP, SERVO_LEG_MID+SERVO_LEG_STEP, SERVO_LEG_MID-SERVO_LEG_STEP]
SERVO_LEG_FWARD_PAIR2_MD2 = [SERVO_LEG_MID+SERVO_LEG_STEP, SERVO_LEG_MID-SERVO_LEG_STEP, SERVO_LEG_MID-SERVO_LEG_STEP]
SERVO_LEG_BACK_PAIR1_MD2  = [SERVO_LEG_MID-SERVO_LEG_STEP, SERVO_LEG_MID-SERVO_LEG_STEP, SERVO_LEG_MID+SERVO_LEG_STEP]
SERVO_LEG_BACK_PAIR2_MD2  = [SERVO_LEG_MID-SERVO_LEG_STEP, SERVO_LEG_MID+SERVO_LEG_STEP, SERVO_LEG_MID+SERVO_LEG_STEP]

SERVO_LEG_ACTION_MODES =[
    [SERVO_LEG_FWARD_PAIR1_MD0, SERVO_LEG_FWARD_PAIR2_MD0, SERVO_LEG_BACK_PAIR1_MD0, SERVO_LEG_BACK_PAIR2_MD0],
    [SERVO_LEG_FWARD_PAIR1_MD1, SERVO_LEG_FWARD_PAIR2_MD1, SERVO_LEG_BACK_PAIR1_MD1, SERVO_LEG_BACK_PAIR2_MD1],
    [SERVO_LEG_FWARD_PAIR1_MD2, SERVO_LEG_FWARD_PAIR2_MD2, SERVO_LEG_BACK_PAIR1_MD2, SERVO_LEG_BACK_PAIR2_MD2] ]
...
def walk(dir=True, SERVO_LEG_ACTION_PAIRS=None):
  SERVO_LEG_FWARD_PAIR1 = SERVO_LEG_ACTION_PAIRS[0]
  SERVO_LEG_FWARD_PAIR2 = SERVO_LEG_ACTION_PAIRS[1]
  SERVO_LEG_BACK_PAIR1  = SERVO_LEG_ACTION_PAIRS[2]
  SERVO_LEG_BACK_PAIR2  = SERVO_LEG_ACTION_PAIRS[3]
...
def controller():
    ...
    mode = int(json_dict['mode'])
    if   act == 'up'      : walk(True, SERVO_LEG_ACTION_MODES[mode])
    elif act == 'down'    : walk(False, SERVO_LEG_ACTION_MODES[mode])
